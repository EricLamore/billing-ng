...
describe('Component Tests', () => {
  describe('InvoiceBilling Management Component', () => {
    let comp: InvoiceBillingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InvoiceBillingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.invoices?.[0]).toEqual(jasmine.objectContaining({ id: 'ABC' }));
    });
