...
describe('Component Tests', () => {
  describe('ProductBilling Management Component', () => {
    let comp: ProductBillingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductBillingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.products?.[0]).toEqual(jasmine.objectContaining({ id: 'ABC' }));
    });
