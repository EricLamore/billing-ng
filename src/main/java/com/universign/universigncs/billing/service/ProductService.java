        ...
        return productRepository
            ...
            .map(
                existingProduct -> {
                    ...
                    if (product.getCertificateTypes() != null) {
                        existingProduct.setCertificateTypes(product.getCertificateTypes());
                    }
                    if (product.getCommercialName() != null) {
                        existingProduct.setCommercialName(product.getCommercialName());
                    }
                    if (product.getProductType() != null) {
                        existingProduct.setProductType(product.getProductType());
                    }
                    if (product.getSettings() != null) {
                        existingProduct.setSettings(product.getSettings());
                    }
                    if (product.getMatrix() != null) {
                        existingProduct.setMatrix(product.getMatrix());
                    }
