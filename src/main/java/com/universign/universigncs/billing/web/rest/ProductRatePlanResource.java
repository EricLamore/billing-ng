...
public class ProductRatePlanResource {
    ...
    public ResponseEntity<ProductRatePlan> updateProductRatePlan(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productRatePlan.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/product-rate-plans/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<ProductRatePlan> partialUpdateProductRatePlan(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productRatePlan.getId())
        );
    }
