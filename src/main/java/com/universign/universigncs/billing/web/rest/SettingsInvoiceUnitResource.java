...
public class SettingsInvoiceUnitResource {
    ...
    public ResponseEntity<SettingsInvoiceUnit> updateSettingsInvoiceUnit(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, settingsInvoiceUnit.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/settings-invoice-units/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<SettingsInvoiceUnit> partialUpdateSettingsInvoiceUnit(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, settingsInvoiceUnit.getId())
        );
    }
