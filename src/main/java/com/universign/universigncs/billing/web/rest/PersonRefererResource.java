...
public class PersonRefererResource {
    ...
    public ResponseEntity<PersonReferer> updatePersonReferer(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, personReferer.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/person-referers/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<PersonReferer> partialUpdatePersonReferer(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, personReferer.getId())
        );
    }
