...
public class SubscriptionFeatureResource {
    ...
    public ResponseEntity<SubscriptionFeature> updateSubscriptionFeature(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, subscriptionFeature.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/subscription-features/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<SubscriptionFeature> partialUpdateSubscriptionFeature(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, subscriptionFeature.getId())
        );
    }
