...
public class RatePlanChargeResource {
    ...
    public ResponseEntity<RatePlanCharge> updateRatePlanCharge(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ratePlanCharge.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/rate-plan-charges/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<RatePlanCharge> partialUpdateRatePlanCharge(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ratePlanCharge.getId())
        );
    }
