...
public class SubscriptionTmpResource {
    ...
    public ResponseEntity<SubscriptionTmp> updateSubscriptionTmp(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, subscriptionTmp.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/subscription-tmps/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<SubscriptionTmp> partialUpdateSubscriptionTmp(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, subscriptionTmp.getId())
        );
    }
