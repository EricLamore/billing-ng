...
public class RatePlanResource {
    ...
    public ResponseEntity<RatePlan> updateRatePlan(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ratePlan.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/rate-plans/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<RatePlan> partialUpdateRatePlan(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ratePlan.getId())
        );
    }
