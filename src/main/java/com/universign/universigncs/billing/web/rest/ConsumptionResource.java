...
public class ConsumptionResource {
    ...
    public ResponseEntity<Consumption> updateConsumption(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, consumption.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/consumptions/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<Consumption> partialUpdateConsumption(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, consumption.getId())
        );
    }
