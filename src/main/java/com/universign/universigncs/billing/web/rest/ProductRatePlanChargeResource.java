...
public class ProductRatePlanChargeResource {
    ...
    public ResponseEntity<ProductRatePlanCharge> updateProductRatePlanCharge(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productRatePlanCharge.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/product-rate-plan-charges/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<ProductRatePlanCharge> partialUpdateProductRatePlanCharge(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productRatePlanCharge.getId())
        );
    }
