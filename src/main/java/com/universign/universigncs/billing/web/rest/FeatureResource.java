...
public class FeatureResource {
    ...
    public ResponseEntity<Feature> updateFeature(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, feature.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Feature> partialUpdateFeature(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, feature.getId())
        );
    }
