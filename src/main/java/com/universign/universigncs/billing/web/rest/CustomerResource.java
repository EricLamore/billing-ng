...
import com.universign.universigncs.billing.service.CustomerService;
...
/**
 * REST controller for managing {@link com.universign.universigncs.billing.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, customer.getId())
        );
    }
