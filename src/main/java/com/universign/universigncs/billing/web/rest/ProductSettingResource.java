...
public class ProductSettingResource {
    ...
    public ResponseEntity<ProductSetting> updateProductSetting(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productSetting.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/product-settings/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<ProductSetting> partialUpdateProductSetting(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productSetting.getId())
        );
    }
