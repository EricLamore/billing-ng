...
public class SettingsInvoiceResource {
    ...
    public ResponseEntity<SettingsInvoice> updateSettingsInvoice(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, settingsInvoice.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/settings-invoices/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<SettingsInvoice> partialUpdateSettingsInvoice(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, settingsInvoice.getId())
        );
    }
