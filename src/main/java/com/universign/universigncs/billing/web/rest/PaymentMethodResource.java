...
public class PaymentMethodResource {
    ...
    public ResponseEntity<PaymentMethod> updatePaymentMethod(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paymentMethod.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<PaymentMethod> partialUpdatePaymentMethod(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paymentMethod.getId())
        );
    }
